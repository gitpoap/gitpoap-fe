...
const SelectItem = forwardRef<HTMLDivElement, ItemProps>(
  ({ color, imageUrl, label, ...props }: ItemProps, ref) => (
    <div ref={ref} {...props}>
      <Group noWrap>
        <TeamLogo color={color} imageUrl={imageUrl} name={label} size={32} />
  ...
  return (
    <Stack align="center" spacing={32}>
      ...
      <Stack spacing={32} sx={{ maxWidth: '100%' }}>
        ...
        {teamName ? (
          <Input style={{ width: '100%' }} label="Team" value={teamName} disabled={true}></Input>
        ) : (
          teams.teamsData && (
            <Select
              style={{ width: '100%' }}
