        ...
        <StyledGrid columns={2} grow>
          <StyledCol span={2} lg={1} style={{ background: darken(0.0, BackgroundPanel2) }}>
            <StyledStack spacing="xl">
              ...
              <ConnectButton onClick={authorizeGitHub} leftIcon={<GoMarkGithub size={16} />}>
                {'CONNECT GITHUB'}
              </ConnectButton>
            </StyledStack>
          </StyledCol>
          <StyledCol span={2} lg={1} style={{ background: darken(0.05, BackgroundPanel2) }}>
            <StyledStack spacing="xl">
              ...
              <Text>
                ...
                >
                  <List.Item>
                    <Tooltip label="We'll award a GitPOAP to anyone who has had a Pull Request merged to your repo in each given year">
